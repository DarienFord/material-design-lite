...
MaterialTabs.prototype.initTabs_ = function () {
    ...
    this.tabs_ = Array.from(this.element_.querySelectorAll('.' + this.CssClasses_.TAB_BAR_CLASS + ' > .' + this.CssClasses_.TAB_CLASS)).filter(function (element) {
        return element.parentElement.parentElement === thatElement;
    });
    this.panels_ = Array.from(this.element_.querySelectorAll('.' + this.CssClasses_.PANEL_CLASS)).filter(function (element) {
